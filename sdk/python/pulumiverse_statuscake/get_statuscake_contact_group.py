...
__all__ = [
    'GetStatuscakeContactGroupResult',
    'AwaitableGetStatuscakeContactGroupResult',
    'get_statuscake_contact_group',
    'get_statuscake_contact_group_output',
]

@pulumi.output_type
class GetStatuscakeContactGroupResult:
    """
...
class AwaitableGetStatuscakeContactGroupResult(GetStatuscakeContactGroupResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetStatuscakeContactGroupResult(
...
def get_statuscake_contact_group(id: Optional[str] = None,
                                 opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetStatuscakeContactGroupResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('statuscake:index/getStatuscakeContactGroup:getStatuscakeContactGroup', __args__, opts=opts, typ=GetStatuscakeContactGroupResult).value

    return AwaitableGetStatuscakeContactGroupResult(
...
@_utilities.lift_output_func(get_statuscake_contact_group)
def get_statuscake_contact_group_output(id: Optional[pulumi.Input[str]] = None,
                                        opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetStatuscakeContactGroupResult]:
    """
    Use this data source to access information about an existing resource.
    """
    ...
