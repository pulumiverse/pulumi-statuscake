...
namespace Pulumiverse.Statuscake.Inputs
{
    ...
    public sealed class StatuscakeUptimeCheckHttpCheckArgs : Pulumi.ResourceArgs
    {
        [Input("basicAuthentication")]
        public Input<Inputs.StatuscakeUptimeCheckHttpCheckBasicAuthenticationArgs>? BasicAuthentication { get; set; }

        [Input("contentMatchers")]
        public Input<Inputs.StatuscakeUptimeCheckHttpCheckContentMatchersArgs>? ContentMatchers { get; set; }
        ...
        public StatuscakeUptimeCheckHttpCheckArgs()
        {
        }
    }
}
