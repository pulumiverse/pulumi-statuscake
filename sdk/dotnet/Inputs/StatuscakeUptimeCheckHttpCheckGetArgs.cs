...
namespace Pulumiverse.Statuscake.Inputs
{
    ...
    public sealed class StatuscakeUptimeCheckHttpCheckGetArgs : Pulumi.ResourceArgs
    {
        [Input("basicAuthentication")]
        public Input<Inputs.StatuscakeUptimeCheckHttpCheckBasicAuthenticationGetArgs>? BasicAuthentication { get; set; }

        [Input("contentMatchers")]
        public Input<Inputs.StatuscakeUptimeCheckHttpCheckContentMatchersGetArgs>? ContentMatchers { get; set; }
        ...
        public StatuscakeUptimeCheckHttpCheckGetArgs()
        {
        }
    }
}
