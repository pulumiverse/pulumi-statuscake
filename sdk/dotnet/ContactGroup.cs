...
namespace Pulumiverse.Statuscake
{
    ...
    public partial class ContactGroup : Pulumi.CustomResource
    {
        ...
        public ContactGroup(string name, ContactGroupArgs? args = null, CustomResourceOptions? options = null)
            : base("statuscake:index/contactGroup:ContactGroup", name, args ?? new ContactGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ContactGroup(string name, Input<string> id, ContactGroupState? state = null, CustomResourceOptions? options = null)
            : base("statuscake:index/contactGroup:ContactGroup", name, state, MakeResourceOptions(options, id))
        {
        }
